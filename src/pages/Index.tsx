...
const features = [
  { icon: Clock, title: "Ready in 10 Minutes", desc: "Fill a simple form and your website is live." },
  { icon: Smartphone, title: "Mobile Responsive", desc: "Looks great on every screen size." },
  { icon: Zap, title: "Lightning Fast", desc: "Optimized for speed and performance." },
  { icon: Shield, title: "SEO Optimized", desc: "Rank higher on Google from day one." },
];
        ...
        <div className="container relative z-10 grid items-center gap-10 lg:grid-cols-2">
          <div className="animate-fade-in-up">
            ...
            <h1 className="text-4xl font-extrabold leading-tight text-primary-foreground sm:text-5xl lg:text-6xl">
              ...
              <span className="underline decoration-accent decoration-4 underline-offset-4">10 Minutes</span>
            </h1>
            <p className="mt-5 max-w-lg text-lg text-primary-foreground/80">
              Get a professional website for your gym, coaching, YouTube channel, or shop starting at ₹499/year
            </p>
      ...
      <section className="py-20">
        <div className="container">
          <h2 className="text-center text-3xl font-bold text-foreground sm:text-4xl">
            Why Choose <span className="text-gradient">SiteKaro?</span>
          </h2>
          <p className="mx-auto mt-3 max-w-xl text-center text-muted-foreground">
            Everything you need to build a professional online presence for your business.
          </p>
      ...
      <section className="bg-hero-gradient py-16">
        <div className="container text-center">
          ...
          <p className="mx-auto mt-3 max-w-md text-primary-foreground/80">
            Join thousands of businesses already using SiteKaro.
          </p>
          <Link to="/create">
